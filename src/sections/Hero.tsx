...
export default function Hero() {
  return (
    <section id="home" className="relative min-h-[90vh] flex items-center justify-center py-20 lg:py-20 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        <div className="relative z-10 flex flex-col items-center lg:items-start text-center lg:text-left">
          ...
          >
            <span className="px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-white text-sm font-semibold tracking-wider uppercase mb-6 inline-block">
          ...
          <motion.h1
            ...
            className="text-5xl md:text-7xl lg:text-8xl font-bold font-outfit leading-tight mb-4"
          >
            Hello, I&apos;m <br />
        ...
        <motion.div
          ...
          className="relative h-[500px] lg:h-[680px] flex justify-center items-center"
        >
          <div
